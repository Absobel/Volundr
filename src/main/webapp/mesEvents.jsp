<%@ include file="header.jsp" %>
    <%@ page language="java" import="model.*, java.util.*, java.text.SimpleDateFormat, java.time.*"
                            ...
                            <% if (ev.getDebutInscr() !=null && ev.getFinInscr() !=null){ LocalDateTime
                                ...
                                L'inscription n'a pas commencée. Début de l'inscription : <%=
                                    ...
                                    <% } else if (debut.isBefore(LocalDateTime.now()) &&
                                        ...
                                        <% } else { %>
                                            L'inscription est terminée. Vous ne pouvez plus soumettre vos préférences.
                                            <br>
                                            <% if (ev.getAffectationDone()) { %>
                                                <a
                                                    href="webscheduler/page_affichage_choix.html?user=<%= userSession.getMail()%>&id=<%= ev.getId()%>">
                                                    Affichage du Choix</a> <br>
                                                <% } else { %>
                                                    L'affectation n'a pas encore été faite. Veuillez revenir plus tard.
                                                    <br>
                                                    <% } } } else { %> Il n'y a pas encore de date associée à cet
                                                        évènement.
                                                        Veuillez revenir plus tard. <br>
                                                        <% } %> <br>
                                                            <% } } } %><br>
                        </p>
