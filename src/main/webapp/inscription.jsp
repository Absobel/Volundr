<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  ...
  <body>
    ...
    <% Integer fail=(Integer) request.getAttribute("fail"); if (fail !=null) { if (fail==1) { %>
          ...
          <form action="Serv" method="post">
            <div>
              ...
              <label for="newpassword">Mot de passe :</label> <input type="password" name="newpassword" id="newpassword"
                required>
              <label for="cword">Confirmer Mot de passe :</label> <input type="password" name="cword" id="cword"
                required>
            </div>
